...
export const ALLOWED_AUDIO_TYPES = ['audio/mpeg', 'audio/wav', 'audio/aac', 'audio/mp4', 'audio/x-m4a', 'audio/flac'];
export const ALLOWED_FOLDERS = ['products', 'members', 'media', 'music', 'site'] as const;
